...
const mockPharmacyRequests: PharmacyRequest[] = [
  ...
  },
  {
    ...
    cantidadTotalDia: 2,
    fechaSolicitud: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString().split("T")[0],
    estado: "entregado",
    fechaPreparacion: new Date(Date.now() - 6 * 24 * 60 * 60 * 1000).toISOString().split("T")[0],
  ...
  },
  {
    ...
    cantidadTotalDia: 5,
    fechaSolicitud: new Date(Date.now() - 6 * 24 * 60 * 60 * 1000).toISOString().split("T")[0],
    estado: "entregado",
    fechaPreparacion: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString().split("T")[0],
    fechaEntrega: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000).toISOString().split("T")[0],
  },
  {
    id: "pr-8",
    ordenMedicaId: "om-8",
    pacienteId: "p-8",
    pacienteNombre: "Diego Herrera",
    habitacion: "402",
    cama: "B",
    enfermera: "María López",
    medicamentos: [
    ...
    cantidadTotalDia: 3,
    fechaSolicitud: new Date(Date.now() - 8 * 24 * 60 * 60 * 1000).toISOString().split("T")[0],
    estado: "entregado",
    fechaPreparacion: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString().split("T")[0],
    fechaEntrega: new Date(Date.now() - 6 * 24 * 60 * 60 * 1000).toISOString().split("T")[0],
  },
  {
    id: "pr-9",
    ordenMedicaId: "om-9",
    pacienteId: "p-9",
    pacienteNombre: "Lucía Ramírez",
    habitacion: "206",
    cama: "A",
    enfermera: "Ana García",
    medicamentos: [
    ...
    cantidadTotalDia: 3,
    fechaSolicitud: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString().split("T")[0],
    estado: "entregado",
    fechaPreparacion: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000).toISOString().split("T")[0],
